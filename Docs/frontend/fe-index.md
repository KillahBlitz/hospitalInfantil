...
5. El área se resuelve por **nombre normalizado** (`plataforma`, `recursos humanos`, ...) y el módulo por **ID numérico** (`1`, `2`, `3`) codificados en el frontend. Ver [[fe-templates-areas-modules]].
...
8. Acciones que **persisten de verdad** en la base: aprobar solicitud, guardar comentario de solicitud, dar de baja usuario, sobreescribir permisos+tipo de usuario. Ver detalle en [[fe-module-accounts]] y [[fe-module-permits]].
...
- Notas hermanas de esta bóveda: [[fe-architecture]], [[fe-routing-guards]], [[fe-pages]], [[fe-templates-areas-modules]], [[fe-module-accounts]], [[fe-module-permits]], [[fe-api-clients]], [[fe-interfaces]], [[fe-session-state]], [[fe-design-system]], [[fe-config-deployment]], [[fe-findings]]
